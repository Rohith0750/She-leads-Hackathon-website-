...
import rulebook from '../assets/SHELEADS 2.0 RULEBOOK.docx';
            ...
            content: (
                <div className="space-y-6">
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>Cross-institution and interdisciplinary teams are NOT allowed.</li>
        ...
        <section id="rules" className="py-24 md:py-32 transition-colors duration-700">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="mt-12 flex justify-center">
                    <a
                        href={rulebook}
                        download="SHELEADS 2.0 RULEBOOK.docx"
